...
> 2D representation
<p>2D 相关的描述内容 </p><br>
 <!--若有两张图片，下面第一行为第一张图片的名字，第二行是第二张图片的名字；当存在第三张图片，请以此类推--> 
...
> 3D visualisation
<p>3D相关描述内容 </p>
<!--riboswitch_name.png：the picture of 3D-->
<img src="riboswitch_name_3D1.svg" alt="drawing" style="width:400px;height:400px;" >
PDBID：请填入pdbID
<!-----------------------------------3d上色-------------------------------------------------->
{
  struct_asym_id: 'A', 
...
<!--riboswitch_name.png：the picture of Binding pocket-->
